...
def insertion_sort(hotels: List[Dict[str, Any]], key: str, order: int) -> Dict[str, Any]:
    ...
    end_time = time.time()
    return {
        'sorted_hotels': hotels[::-order][:100],
        'time': end_time - start_time
    }


def selection_sort(hotels: List[Dict[str, Any]], key: str, order: int) -> Dict[str, Any]:
    start_time = time.time()
...
def bubble_sort(hotels: List[Dict[str, Any]], key: str, order: int) -> Dict[str, Any]:
    start_time = time.time()
    n = len(hotels)
    for i in range(n):
